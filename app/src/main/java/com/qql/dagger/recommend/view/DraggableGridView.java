...
public class DraggableGridView extends ViewGroup implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
    ...
    {
        System.out.println("DraggableGridView.onTouch()");
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dragged != -1)
                {
                    ...
                    getChildAt(dragged).layout(l, t, l + (int)(childSize * 3 / 2.5), t + (int)(childSize * 3 / 2.5));
    ...
    public void setAdapter(BookSelfAdapter adapter){
        for (int i=0;i<adapter.getCount();i++){
            addView(adapter.getView(i,view,null));
        }
    }
