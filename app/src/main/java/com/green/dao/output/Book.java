...
public class Book {
    ...
    @Generated
    public Book(Long id, String user_id, String title, String cover_url, String content_url, String author, Double read_rate, String formats, Boolean probation, String bookmarks, String notes, String remarks, String folder, Long last_read_time) {
        this.id = id;
